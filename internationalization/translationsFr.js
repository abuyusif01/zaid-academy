const translationsFr = {
  ...
  missions: [
    "Enseigner le coran aux personnes de tous âges ",
  ...
  teachers: [
    {
      ...
      // image: Mohammad1,
      shortBio:
        "Ousmane Yahya Diallo est le co-fondateur de Zaid Academy. C'est un instructeur renommé du Coran spécialisé dans des aspects tels que le Tajwid, le Hifz (Mémorisation) avec certification (Ijazah et Sanad), il a appris le coran au près de nombreux éminents érudits, ainsi que dans des institutions réputées à travers le monde.  Il a obtenu un baccalauréat en jurisprudence et en études islamiques de l'Université Al Qasimia en 2020. Ousmane a commencé à enseigner le Saint Coran dès 2012 après avoir mémorisé le Saint Coran. Maîtrisant les trois langues largement parlées, à savoir l'arabe, le français et l'anglais, ainsi que sa langue maternelle, le peul et le wolof, le co-fondateur de Zaid Academy poursuit actuellement une maîtrise en finance islamique à l'International  Université islamique de Malaisie (IIUM) dans le but de fournir des cours coraniques de qualité et efficaces.",
      education: [
  ...
  toRegister: "Pour vous inscrire, contactez :",
  whatsapp: "+60-11-1605-0164 sur Whatsapp",
  fillForm: "ou remplissez le formulaire ci-dessous",
  ...
  struggle:
    "Vous n'avez pas à lutter seul, vous avez notre assistance et notre aide",
  monthly: "mois",
  ...
  classes: "Leçons / mois",
  weeklyClass: "Classes par semaine",
